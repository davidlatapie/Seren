...
static const uint256 hashGenesisBlockOfficial("0xd564f742965ac463e4ee7af2c087053721ff1bf2973fbf5fd2e2e2c7c2af36c1");
static const uint256 hashGenesisBlockTestNet ("0x37597ac85a502b428f2a9a7ed3b60d34a2de47f95ed66608479c0c707f52645b");
...
extern unsigned int nStakeMinAgeFastPoS;
...
public:
    ...
    */
    ...
    {
        //  do not allow free transactions
        return false;
    }
	
	int64 GetValueInForValueBasedFee() const; //presstab
	
	int64 GetValueBasedFee() const //presstab
	{
		if(IsCoinStake())
			return 0;
		
		int64 nValueInForFee = GetValueInForValueBasedFee();
		int64 nValueBasedFee = 0;
		if(nValueInForFee < 10 * COIN)
			nValueBasedFee = nValueInForFee * FEE_ON_AMOUNT / 100;
		else
		{
			//fee on first 10 coins
			nValueBasedFee =  (10 * COIN * FEE_ON_AMOUNT / 100);
			
			//fee on the rest of the coins
			nValueBasedFee += (nValueInForFee - (10 * COIN)) * FEE_ON_AMOUNT / 1000; // 0.1% for over 10 coins
		}
		
		return std::min(nValueBasedFee, 1000 * COIN);
	}
