...
static const unsigned int MODIFIER_INTERVAL = 1233; //about 1/2 day for a full modifier
static const unsigned int MODIFIER_INTERVAL_TESTNET = 60; //about 35 minutes for a full modifier
...
bool stakeTargetHit(uint256 hashProofOfStake, unsigned int nIntervalBeginning, unsigned int nIntervalEnd, int64 nValueIn, CBigNum bnTargetPerCoinDay);
