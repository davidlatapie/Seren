...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Seren can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr("Seren"),
    ...
    app.setOrganizationName("Seren");
    app.setOrganizationDomain("Seren.su");
